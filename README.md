...
```bash
sh -c "`curl -fsSL https://github.com/ArthurNovaes/dotfiles/blob/master/install.sh`"
```
...
```bash
sh -c "`curl -fsSL https://github.com/ArthurNovaes/dotfiles/blob/master/install.sh`" -s ask
```
