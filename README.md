...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/arthurnovaes/dotfiles/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/arthurnovaes/dotfiles/master/install.sh`" -s ask
```
